...
1. Upload the plugin files to the `/wp-content/plugins/social-icons-for-woocoomerce-emails` directory, or install the plugin through the WordPress plugins screen directly.
